...
public class FertilizerCalculatorActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        etCurrentNPK = findViewById(R.id.etCurrentNPK);
    ...
    private void calculateFertilizer() {
        try {
            ...
            if (areaText.isEmpty()) {
                Toast.makeText(this, "Please enter field area", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            // Calculate fertilizer requirements based on crop and soil type
    ...
    private FertilizerRecommendation calculateFertilizerRequirement(double area, String cropType, String soilType, String currentNPK) {
        ...
        switch (soilType) {
            case "Sandy":
                soilMultiplier = 1.2; // More fertilizer needed
                break;
            case "Clay":
                soilMultiplier = 0.8; // Less fertilizer needed
                break;
            case "Loamy":
                soilMultiplier = 1.0; // Standard
                break;
        }
        
        // Calculate for given area (assuming area is in hectares)
