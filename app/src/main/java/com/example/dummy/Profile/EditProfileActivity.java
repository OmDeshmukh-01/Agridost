...
// Session/profile update will be added later with Firebase
...
public class EditProfileActivity extends BaseActivity {
    ...
    private void loadCurrentUser() {
        ...
        if (currentUser != null) {
            ...
            // Prefill from SharedPreferences if available
    ...
    private void saveProfile() {
        ...
        // Persist to SharedPreferences (acts as simple local profile store)
        android.content.SharedPreferences prefs = getSharedPreferences("app_prefs", MODE_PRIVATE);
        prefs.edit()
                .putString("profile_name", name)
                .putString("profile_description", description)
                .putString("profile_location", location)
                .putString("profile_phone", phoneNumber)
                .putString("profile_avatar_path", selectedImagePath != null ? selectedImagePath : "")
                .apply();
