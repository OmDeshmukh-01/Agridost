...
public class ProfitEstimatorFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_profit_estimator, container, false);
    ...
    private void initializeViews(View root) {
        ...
        etExpectedYield = root.findViewById(R.id.etExpectedYield);
        etMarketPrice = root.findViewById(R.id.etMarketPrice);
        etSeedCost = root.findViewById(R.id.etSeedCost);
        etFertilizerCost = root.findViewById(R.id.etFertilizerCost);
        etLaborCost = root.findViewById(R.id.etLaborCost);
        etOtherCosts = root.findViewById(R.id.etOtherCosts);
    ...
    private void calculateProfit() {
        try {
            ...
            Toast.makeText(requireContext(), "Please enter valid numbers in all fields", Toast.LENGTH_SHORT).show();
        }
    }
